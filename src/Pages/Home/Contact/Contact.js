...
import image from '../../../assets/images/photo-1423666639041-f56000c27a9a.jpeg'
const Contact = () => {
    ...
    return (
        <div>
            <section id="contact" className="contact py-12 mx-5">
                {/* HEADINGS */}
                ...
                <div className="md:flex md:justify-between gap-16 mt-5">
                    ...
                    <div className='w-50'>
                        ...
                        <img src={image} className='w-full rounded-lg' alt="contact" />
                    ...
                    <form
                        ...
                        method="POST"
                        className='mx-5 rounded-lg bg-red-300 p-12  lg:mx-0'
                    >
                        <input
