...
const CategoryProducs = ({ category, setData }) => {


    const { description, gender, image, location, original_price, posted_time, product_company_name, product_name, rating, resale_price, seller_name, years_of_use } = category;
    return (
        <div>
